...
/* =====================================================
   REAL SENSOR READERS
   ===================================================== */
static uint8_t readRealPlot1() { return map(analogRead(34), 0, 4095, 0, 255); }
static uint8_t readRealPlot2() { return map(analogRead(35), 0, 4095, 0, 255); }
static uint8_t readRealPlot3() { return map(analogRead(32), 0, 4095, 0, 255); }
